...
HOME_TOGGLE_DELAY = 2.0  # Delay in seconds for home button toggle
APP_SELECT_DELAY = 2.0  # Delay to prevent immediate app launch
...
if __name__ == '__main__':
    SCREEN_WIDTH = int(os.getenv('SCREEN_WIDTH'))
    SCREEN_HEIGHT = int(os.getenv('SCREEN_HEIGHT'))
    os.environ['SDL_VIDEO_WINDOW_POS'] = '4480,0'
